...
function change_vid_visibility(visible) {
  document.getElementById("show_vids").style.display = (visible ? "none" : "block");
  document.getElementById("hide_vids").style.display = (visible ? "block" : "none");

  var elems = document.getElementsByClassName("hidden_vid");
  for(e = 0; e < elems.length; e++) {
    elems[e].style.display = (visible ? "block" : "none");
  }
}
